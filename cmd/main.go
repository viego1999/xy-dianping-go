...
func main() {
	...
	fx.New(
		...
		fx.Provide(repo.NewUserRepository, repo.NewUserInfoRepository, repo.NewShopRepository, repo.NewVoucherRepository,
			repo.NewSeckillVoucherRepository, repo.NewBlogRepository),
		...
		fx.Provide(v1.NewUserController, v1.NewShopController, v1.NewVoucherController, v1.NewBlogController),
		// 导入路由模块
		api.Module,
